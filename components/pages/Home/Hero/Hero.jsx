  ...
  return (
    <div className='flex md:flex-row flex-col lg:gap-12 gap-6  items-center h-screen  bg-gradient-to-r from-gray-100 via-[#E5FBFF] to-gray-100  '>
        <div className=' md:w-1/2 w-full flex items-center '>
          ...
          <h2 className='text-primary lg:text-[64px] md:text-[44px] font-medium  leading-tight font-custom '>Providing <span className='text-secondary'>Exceptional </span> Home Care Services</h2>
