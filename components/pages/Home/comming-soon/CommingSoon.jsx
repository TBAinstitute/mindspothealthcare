    ...
    <div className='flex px-24 md:flex-row flex-col'>
            ...
            <div className='md:w-1/2 w-full flex flex-col justify-between text-neutral '>
                    <div className='flex flex-col gap-4'>
                            <h2 className='md:text-[18px] text-[#736D6D]'>Health</h2>
                            <div className='gap-6 flex items-center'>
                                <Image src={soon1} alt='img1' className='w-[21%] md:h-[130px] rounded-[10px]' />
                    ...
                    <div className='flex flex-col gap-6'>
                            <h2 className='md:text-[18px] text-[#736D6D]'>Nutrition</h2>
                            <div className='gap-6 flex items-center'>
                                <Image src={soon3} alt='img1' className='w-[23%] md:h-[130px] rounded-[10px]'/>
